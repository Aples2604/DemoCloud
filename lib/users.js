...
let users = [
  {
    id: 0,
    username: "21C11045",
    password: "$2b$10$EeXBDpZv2bcIlSpHn0tkoeiVzqYVE64zLqxf3Oq.FFvoq1iv2ex96",
    email: "21C11045@student.hcmus.edu.vn",
  },
];
// ----------------------------------------------------*
...
export async function login(username, password)  {
  ...
  const isLogin = await checkPassword(password, user.password)
